...
namespace FreeBudget.Transactions.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260514063805_ImportLayoutCurrencyAccountMap")]
    partial class ImportLayoutCurrencyAccountMap
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FreeBudget.Transactions.Domain.Entities.ImportLayoutDefinition", b =>
                {
                    ...
                    b.Property<string>("CurrencyAccountMappings")
                        .IsRequired()
                        .HasColumnType("jsonb")
                    ...
                    b.Property<string>("TargetAmountColumn")
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)")
                        .HasColumnName("target_amount_column");

                    b.Property<string>("TargetCurrencyColumn")
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)")
                        .HasColumnName("target_currency_column");
